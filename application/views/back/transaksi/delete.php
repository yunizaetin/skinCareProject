...
<div class="content-wrapper">
   ...
   <section class="content">
         <div class="box box-default">
            ...
            <form action="<?=site_url()?>back/transaksi/delete_process" method="post" class="form-horizontal" onsubmit="return confirm('Transaksi yang sudah dihapus tidak dapat dikembalikan lagi. Hapus transaksi ini?')">
              <div class="box-body">
                 <?php $this->load->view('back/include/notification') ?>
                <input type="hidden" name="id_pembelian" value="<?= $detail['id_pembelian'] ?>">
                <p class="text-danger">
                  * Transaksi yang sudah dihapus tidak dapat dikembalikan lagi. Hapus transaksi ini?
                </p>
                <input type="hidden" name="id_pembelian" value="<?= $detail['id_pembelian'] ?>">
